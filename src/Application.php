...
class Application extends BaseApplication implements AuthenticationServiceProviderInterface
{
    ...
    public function getAuthenticationService(ServerRequestInterface $request): AuthenticationServiceInterface
    {
        ...
        // Definimos a dónde redirigir si no está autenticado
        $service->setConfig([
        ...
        // Definimos los campos que usas (tú usas 'email' como nombre de usuario)
        $fields = [
            PasswordIdentifier::CREDENTIAL_USERNAME => 'email',
            PasswordIdentifier::CREDENTIAL_PASSWORD => 'password',
        ];

        // Cargamos los autenticadores
        // Session debe ir primero para que el login persista
        ...
        $service->loadAuthenticator('Authentication.Form', [
            ...
            // Aquí es donde cargamos el identificador dentro del autenticador
            'identifier' => [
